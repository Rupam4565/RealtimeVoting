...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars.packages", 
                     "org.apache.spark:spark-sql-kafka-0-10_2.13:4.0.0-preview2")  # Match Scala version with your Spark
             .config("spark.jars", 
                     "/home/rupamlinux/DE_Projects/VotingEngineering/postgresql-42.7.4.jar")  # PostgreSQL driver
    ...
    votes_per_candidate = enriched_votes_df.groupBy("candidate_id", "candidate_name", "party_affiliation").agg(_sum("vote").alias("total_votes"))
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/path/to/checkpoint1") \
        .outputMode("update") \
        .start()
